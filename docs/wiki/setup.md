...
- Production ops (systemd, gunicorn flags, cache cleanup, **monitoring/capacity**) live in root [`AGENTS.md`](../../AGENTS.md) and [`ops/monitoring/`](../../ops/monitoring/README.md), not only here.
