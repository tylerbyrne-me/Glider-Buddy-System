...
- [Mission catalog cutover](./how-tos/mission_catalog_cutover.md) — ST auto-enrollment + Team ops UI (readiness/health/enrollment/provision) 2026-09-10; empty-env + consumer flags soaked; Slocum source-late waits on ERDDAP (ADR 0005)
