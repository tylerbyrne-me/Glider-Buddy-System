...
- [x] 2026-08-10 — Fix empty vector-layer catalog on prod: root `.gitignore` `*.json` was excluding `config/map_layers/manifest.json` (GeoJSON was tracked; toggles need the manifest) — allowlist + clearer empty-state / how-to note
