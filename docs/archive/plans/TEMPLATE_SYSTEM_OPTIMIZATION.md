...
{% if features.pic_management %}
    <a href="/my_pic_handoffs.html">PIC Handoffs</a>
{% endif %}
...
FEATURE_TOGGLES_JSON={"pic_management": true, "admin_management": true, "station_offloads": true, "mission_dashboard": true, "forms": true, "reporting": true, "authentication": true}
```
